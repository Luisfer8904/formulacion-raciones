...
def ejecutar_migracion_limites():
    ...
    try:
        ...
        columnas_nombres = [col['COLUMN_NAME'] for col in columnas_existentes]
        ...
        for columna in columnas:
            tipo = columna['Type']
            nulo = 'NULL' if columna['Null'] == 'YES' else 'NOT NULL'
            default = f"DEFAULT {columna['Default']}" if columna['Default'] else ''
            print(f"   {columna['Field']}: {tipo} {nulo} {default}")
