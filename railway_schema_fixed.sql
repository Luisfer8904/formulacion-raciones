...
-- Create usuarios table first (missing from the original file)
...
-- Insert admin user
INSERT IGNORE INTO `usuarios` VALUES (1,'Admin','admin@formulacion.com','admin123','admin',NULL,NULL,NULL,NULL,'es','claro','2025-01-10 12:00:00');
INSERT IGNORE INTO `usuarios` VALUES (2,'Usuario 2','user2@test.com','pass123','user',NULL,NULL,NULL,NULL,'es','claro','2025-01-10 12:00:00');
INSERT IGNORE INTO `usuarios` VALUES (3,'Usuario 3','user3@test.com','pass123','user',NULL,NULL,NULL,NULL,'es','claro','2025-01-10 12:00:00');
INSERT IGNORE INTO `usuarios` VALUES (4,'Usuario 4','user4@test.com','pass123','user',NULL,NULL,NULL,NULL,'es','claro','2025-01-10 12:00:00');

-- Create nutrientes table (missing from the original file)
CREATE TABLE IF NOT EXISTS `nutrientes` (
  ...
  CONSTRAINT `nutrientes_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Insert basic nutrients
INSERT IGNORE INTO `nutrientes` VALUES (1,'Proteína Bruta','%','Macronutriente',NULL,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (2,'Calcio','%','Mineral',NULL,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (3,'Fósforo','%','Mineral',NULL,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (9,'Fibra Bruta','%','Macronutriente',NULL,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (11,'Calcio','%','Mineral',3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (12,'Fósforo','%','Mineral',3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (14,'Magnesio','%','Mineral',3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (15,'Azufre','%','Mineral',3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (16,'Vitamina A','UI/kg','Vitamina',3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (18,'Proteína Bruta','%','Macronutriente',4,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (19,'Energía Metabolizable','Kcal/kg','Energía',4,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (21,'Hierro','ppm','Mineral',3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (22,'Cobre','ppm','Mineral',3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (23,'Cobalto','ppm','Mineral',3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (24,'Zinc','ppm','Mineral',3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (25,'Selenio','ppm','Mineral',3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (26,'Sodio','%','Mineral',3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (27,'Cloro','%','Mineral',3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (28,'Proteína Equivalente','%','Macronutriente',3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (29,'Proteína Verdadera','%','Macronutriente',3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `nutrientes` VALUES (30,'Energía Digestible','Kcal/kg','Energía',3,'2025-01-10 12:00:00');

-- Create requerimientos table (missing from the original file)
CREATE TABLE IF NOT EXISTS `requerimientos` (
  ...
  PRIMARY KEY (`id`),
  KEY `usuario_id` (`usuario_id`),
  CONSTRAINT `requerimientos_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Insert basic requirements
INSERT IGNORE INTO `requerimientos` VALUES (4,'Bovino Adulto','Bovino','Mantenimiento','Requerimientos para bovino adulto en mantenimiento',3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `requerimientos` VALUES (6,'Bovino Crecimiento','Bovino','Crecimiento','Requerimientos para bovino en crecimiento',3,'2025-01-10 12:00:00');

-- Create mezclas table (missing from the original file)
CREATE TABLE IF NOT EXISTS `mezclas` (
  ...
  PRIMARY KEY (`id`),
  KEY `usuario_id` (`usuario_id`),
  CONSTRAINT `mezclas_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Insert basic mezclas
INSERT IGNORE INTO `mezclas` VALUES (18,'Mezcla Aves','Mezcla para aves de corral','Aves','Engorde',NULL,4,'2025-01-10 12:00:00');
INSERT IGNORE INTO `mezclas` VALUES (69,'Mezcla Mineral 1','Mezcla mineral básica','Bovino','Mantenimiento',NULL,3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `mezclas` VALUES (70,'Mezcla Mineral 2','Mezcla mineral avanzada','Bovino','Crecimiento',NULL,3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `mezclas` VALUES (73,'Mezcla Fosfato 1','Mezcla con fosfato','Bovino','Mantenimiento',NULL,3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `mezclas` VALUES (74,'Mezcla Fosfato 2','Mezcla con fosfato avanzada','Bovino','Crecimiento',NULL,3,'2025-01-10 12:00:00');
INSERT IGNORE INTO `mezclas` VALUES (75,'Mezcla Completa','Mezcla completa con todos los nutrientes','Bovino','Engorde',NULL,3,'2025-01-10 12:00:00');
